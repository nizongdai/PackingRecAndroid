...
data class DetectionSettings(
    ...
    val localVideoRetentionDays: Int,
...
class AppSettings(context: Context) {
    ...
    fun load(): DetectionSettings {
        ...
        val maxRecordingSeconds = prefs.getInt("maxRecordingSeconds", 180)
        val localVideoRetentionDays = prefs.getInt("localVideoRetentionDays", 10)
    ...
    fun save(settings: DetectionSettings) {
        prefs.edit()
            ...
            .putInt("maxRecordingSeconds", settings.maxRecordingSeconds)
            .putInt("localVideoRetentionDays", settings.localVideoRetentionDays)
